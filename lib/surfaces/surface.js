  ...
  BT2D.Surface = (function() {
    ...
    Surface.prototype.emitScatteringFrustrums = function(incomingLightFrustrum, output) {
      ...
      if (this._geometry instanceof BT2D.Line) {
        ...
        if (bounces_incoming !== 0) {
          console.log(bounces_incoming);
        }
        ...
        if (end1.clone().sub(end2).length() < BT2D.Constants.MINNIMUM_SCATTER_SEPARATION && outgoing_dir1.clone().dot(outgoing_dir2) > .999) {
