  ...
  BT2D.Surface = (function() {
    ...
    Surface.prototype.emitSourceFrustrums = function() {
      ...
      if (this._geometry instanceof BT2D.Line) {
        ...
        lightFrustrum = new BT2D.LightFrustrum(frustrum, initial_spectrum, initial_spectrum, this._geometry);
    ...
    Surface.prototype.emitScatteringFrustrums = function(incomingLightFrustrum, output) {
      var end1, end2, incoming_dir1, incoming_dir2, input_frustrum, lightFrustrum, line, outgoing_dir1, outgoing_dir2, perp_1, perp_2, scattered_frustrum, spectrum_1, spectrum_2, specular_reflectance_spectrum;
      input_frustrum = incomingLightFrustrum.frustrum;
      if (this._geometry instanceof BT2D.Line) {
        specular_reflectance_spectrum = this._material.getSpecularSpectrum();
        ...
        lightFrustrum = new BT2D.LightFrustrum(scattered_frustrum, spectrum_1, spectrum_2, this._geometry);
