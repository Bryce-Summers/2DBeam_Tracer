...
(function() {
  BT2D.LightFrustrum = (function() {
    ...
    LightFrustrum.prototype.fudge = function(min_time1, min_time2) {
      return this.frustrum.fudge(min_time1, min_time2);
    };

    LightFrustrum.prototype.unfudge = function() {
      return this.frustrum.unfudge();
    };
