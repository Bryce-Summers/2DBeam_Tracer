...
(function() {
  BT2D.BSP = (function() {
    ...
    BSP.prototype.intersectFrustrum = function(lightFrustrum, min_time1, min_time2) {
      var bp_left, bp_right, classification_left, classification_right, classifier, focus, found, frustrum, frustrum_side, left_frustrum, otherSide, perp_1, perp_2, pt_left, pt_right, ray_left, ray_right, ref, ref1, ref2, ref3, right_frustrum, surface, time1, time2;
      ...
      if ((!found) && otherSide !== null) {
        ...
        ref3 = otherSide.intersectFrustrum(lightFrustrum, time1 - 2 * BT2D.Constants.EPSILON / perp_1, time2 - 2 * BT2D.Constants.EPSILON / perp_2), found = ref3[0], left_frustrum = ref3[1], right_frustrum = ref3[2], surface = ref3[3];
      }
