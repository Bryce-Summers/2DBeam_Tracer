...
(function() {
  BT2D.BSP = (function() {
    ...
    BSP.prototype.intersectFrustrum = function(lightFrustrum, min_time1, min_time2) {
      var bp_left, bp_right, classification_left, classification_right, classifier, focus, found, frustrum, frustrum_side, left_frustrum, original_min_time1, original_min_time2, otherSide, perp_1, perp_2, pt_left, pt_right, ray_left, ray_right, ref, ref1, ref2, ref3, right_frustrum, surface, temp, time1, time2;
      ...
      while (true) {
         ...
         */
        perp_1 = this._bp.getPerpendicularPercentage(ray_left.getDirection());
        perp_2 = this._bp.getPerpendicularPercentage(ray_right.getDirection());
        if (classification_left === BT2D.Constants.ON && classification_right === BT2D.Constants.ON) {
          ...
          continue;
        } else if (classification_left === BT2D.Constants.ON && classification_right !== BT2D.Constants.ON) {
          temp = min_time1;
        ...
        } else if (classification_right === BT2D.Constants.ON && classification_left !== BT2D.Constants.ON) {
          temp = min_time2;
      ...
      if (frustrum_side !== null) {
        ref1 = frustrum_side.intersectFrustrum(lightFrustrum, original_min_time1, original_min_time2), found = ref1[0], left_frustrum = ref1[1], right_frustrum = ref1[2], surface = ref1[3];
      }
      if (found) {
      ...
      if ((!found) && otherSide !== null) {
         ...
         */
        ref3 = otherSide.intersectFrustrum(lightFrustrum, time1, time2), found = ref3[0], left_frustrum = ref3[1], right_frustrum = ref3[2], surface = ref3[3];
      }
