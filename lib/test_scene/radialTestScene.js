...
(function() {
  ...
  BT2D.RadialTestScene = (function(superClass) {
    ...
    function RadialTestScene(n) {
      ...
      this.specularSourceMaterial.setSpecularGreen(blueSpectrum);
      this.createScene(n);
    }
    ...
    RadialTestScene.prototype.createBasicTestScene = function(n) {
       ...
       */
      this.createSurface(this.specularSourceMaterial, new THREE.Vector3(-10, 10, 0), new THREE.Vector3(10, 9, 0));
      return this.createSurface(this.specularSourceMaterial, new THREE.Vector3(19, 20, 0), new THREE.Vector3(20, -20, 0));
    };
