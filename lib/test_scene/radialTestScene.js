...
(function() {
  ...
  BT2D.RadialTestScene = (function(superClass) {
    ...
    RadialTestScene.prototype.createBasicTestScene = function(n) {
       ...
       */
      this.createSurface(this.absorptiveSourceMaterial, new THREE.Vector3(-10, 0, 0), new THREE.Vector3(10, 3, 0));
      return this.createSurface(this.absorptiveSourceMaterial, new THREE.Vector3(-10, 0, 0), new THREE.Vector3(-5, 5, 0));
    };
