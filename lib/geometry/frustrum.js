...
(function() {
  BT2D.Frustrum = (function() {
    function Frustrum(_start1, _start2, _dir1, _dir2) {
      this._original_start1 = _start1.clone();
      this._original_start2 = _start2.clone();
      this._dir1 = _dir1.clone();
      this._dir2 = _dir2.clone();
      this._dir1.normalize();
      this._dir2.normalize();
      this.original_dir1 = this._dir1.clone();
      this.original_dir2 = this._dir2.clone();
    ...
    Frustrum.prototype.checkDegenerate = function() {
      ...
      dir_length1 = this._dir1.length();
      dir_length2 = this._dir2.length();
      if (dir_length1 > 2) {
    ...
    Frustrum.prototype.getSplitRay = function(pt) {
      ...
      if (bp_start !== null) {
        ...
        dist1 = split_start.clone().sub(this._start1).length();
        dist2 = split_start.clone().sub(this._start2).length();
    ...
    Frustrum.prototype.getOrientationRay = function(pt) {
      var center_pt, ray;
      center_pt = this._start1.clone().add(this._start2).divideScalar(2.0);
      ray = new BT2D.Line(center_pt, pt);
      ray.makeRay();
      return ray;
    };

    Frustrum.prototype.fudge = function(min_time1, min_time2) {
      this.unfudge();
      this._start1 = this.getLeftRay().getPosition(min_time1);
      return this._start2 = this.getRightRay().getPosition(min_time2);
    };

    Frustrum.prototype.unfudge = function() {
      this._start1 = this._original_start1.clone();
      return this._start2 = this._original_start2.clone();
    };
