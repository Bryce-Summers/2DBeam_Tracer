...
(function() {
  BT2D.Frustrum = (function() {
    ...
    Frustrum.prototype.getLeftBP = function() {
      return new BT2D.Line(this._start1, this.dir1, BT2D.Line.RAY);
    };

    Frustrum.prototype.getRightBP = function() {
      return new BT2D.Line(this._start2, this.dir2, BT2D.Line.RAY);
    };
    ...
    Frustrum.prototype.getFocusPoint = function() {
      ...
      left.makeUnbounded();
      if (!(left.intersect(right, intersection))) {
        return null;
      }
