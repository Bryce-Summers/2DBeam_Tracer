...
(function() {
  BT2D.FrustrumTracer = (function() {
    ...
    FrustrumTracer.prototype.addPointLight = function() {
      var NE, NW, absorptiveSourceMaterial, center, down, emmissiveSourceMaterial, f0, f1, full, fullIntensitySpectrum, left, lightf0, lightf1, noIntensitySpectrum, right, up;
    ...
    FrustrumTracer.prototype._traceFrustrum = function(lightFrustrum, surfaceSet) {
      ...
      ref = surfaceSet.intersectFrustrum(lightFrustrum, -BT2D.Constants.EPSILON, -BT2D.Constants.EPSILON), found = ref[0], left = ref[1], right = ref[2], surface = ref[3];
      if (!found) {
